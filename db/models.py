...
class Service(Base):
    ...
    name: Mapped[str] = mapped_column(String, nullable=False)
    monitor_type: Mapped[str] = mapped_column(String, nullable=False, server_default="http_ping")
    url: Mapped[str | None] = mapped_column(String)
    status_page_api_urls: Mapped[str | None] = mapped_column(String)
    user_defined_urls: Mapped[str | None] = mapped_column(String)
